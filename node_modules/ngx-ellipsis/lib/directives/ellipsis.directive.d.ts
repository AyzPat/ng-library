import { ElementRef, Renderer2, EventEmitter, NgZone } from '@angular/core';
/**
 * Directive to truncate the contained text, if it exceeds the element's boundaries
 * and append characters (configurable, default '...') if so.
 */
export declare class EllipsisDirective {
    private elementRef;
    private renderer;
    private ngZone;
    /**
     ...
     */
    private addResizeListener(triggerNow?);
     ...
     */
    private addElementResizeListener(scrollStrategy?);
    /**
     ...
     */
    private truncateText(max, addMoreListener?);
    /**
     ...
     */
    private static numericBinarySearch(max, callback);
}
